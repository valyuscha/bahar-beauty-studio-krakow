                  ...
                  >
                    ...
                    <div className="sm:col-span-1">
                      ...
                      <select
                        ...
                        value={form.service}
                        onChange={onChange}
                        className="mt-2 w-full bg-transparent text-foreground border-b border-border focus:border-primary outline-none py-2 text-base appearance-none cursor-pointer"
